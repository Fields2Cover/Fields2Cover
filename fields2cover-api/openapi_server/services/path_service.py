...
def generate_path(workingLanes: str, transport_lanes: str, start_point: Point, end_point: Point, robotSettings: RobotSettings, sorter_settings: SorterSettings, curvesAlgorithm: str):    

    robot = create_robot(robotSettings)
    route = generate_route(workingLanes, transport_lanes, start_point, end_point, sorter_settings)
