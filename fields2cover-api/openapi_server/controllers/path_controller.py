...
def generate_path_post(generate_path_post_request):  # noqa: E501
    ...
    path = generate_path(json.dumps(req_json["workingLanes"]), json.dumps(req_json["transportLanes"]), req.start_point, req.end_point, req.robot_settings , req.sorter_settings, req.curves_algorithm)    
